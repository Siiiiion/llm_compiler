...
def best_lines_convert():
    ...
    with open(f'/data3/qsy/gen_data/{HARDWARE_PLATFORM}_gen_best/0_merge.json', 'r') as f:
        lines = f.read().strip().split('\n')

    target_path = f'/data3/qsy/gen_data/measure_data_{HARDWARE_PLATFORM}/best.json'
